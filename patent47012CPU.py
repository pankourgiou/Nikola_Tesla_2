...
image_path = "patent 47012.png"  # Replace with your .png file
...
button_window = canvas.create_window(340, 390, anchor=tk.NW, window=button)

# Label to display CPU usage
label = Label(root, text="CPU Usage: --%", bg="black", fg="white")
label_window = canvas.create_window(390, 440, anchor=tk.NW, window=label)
